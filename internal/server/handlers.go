...
import (
	...
	"github.com/micaelparadox/api-mc/docs"
	"github.com/micaelparadox/api-mc/pkg/csrf"

	"github.com/labstack/echo/v4"
	"github.com/labstack/echo/v4/middleware"
	echoSwagger "github.com/swaggo/echo-swagger"

	// _ "github.com/micaelparadox/api-mc/docs"
	authHttp "github.com/micaelparadox/api-mc/internal/auth/delivery/http"
	authRepository "github.com/micaelparadox/api-mc/internal/auth/repository"
	authUseCase "github.com/micaelparadox/api-mc/internal/auth/usecase"
	commentsHttp "github.com/micaelparadox/api-mc/internal/comments/delivery/http"
	commentsRepository "github.com/micaelparadox/api-mc/internal/comments/repository"
	commentsUseCase "github.com/micaelparadox/api-mc/internal/comments/usecase"
	apiMiddlewares "github.com/micaelparadox/api-mc/internal/middleware"
	newsHttp "github.com/micaelparadox/api-mc/internal/news/delivery/http"
	newsRepository "github.com/micaelparadox/api-mc/internal/news/repository"
	newsUseCase "github.com/micaelparadox/api-mc/internal/news/usecase"
	sessionRepository "github.com/micaelparadox/api-mc/internal/session/repository"
	"github.com/micaelparadox/api-mc/internal/session/usecase"
	"github.com/micaelparadox/api-mc/pkg/metric"
	"github.com/micaelparadox/api-mc/pkg/utils"
)
